            ...
            <div id="content">
                ...
                <% else %>
                    ...
                    <div class="6u -3u 12u(1)">
                        <h2><%t StudentProfileView.PROFILENAME "{firstName} {surname}'s Profile" firstName={$Member.FirstName} surname={$Member.Surname} %></h2>
                        <p><%t StudentProfileView.LOGINREMINDER "You need to be logged in to the view this profile!" %></p> 
                        <p><%t <a href="Security/login">Login</a> or <a href="register">Register</a> to view profiles.</p>
                    </div>
                    </div>
                <% end_if %>
                </article>
